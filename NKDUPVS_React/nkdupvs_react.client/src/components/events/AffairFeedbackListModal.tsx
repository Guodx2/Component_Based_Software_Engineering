...
interface AffairFeedbackListModalProps {
    affairName: string;
    feedbacks: Feedback[];
    onClose: () => void;
}
...
const AffairFeedbackListModal: React.FC<AffairFeedbackListModalProps> = ({ affairName, feedbacks, onClose }) => {
    return (
        <div style={{
...
export default AffairFeedbackListModal;